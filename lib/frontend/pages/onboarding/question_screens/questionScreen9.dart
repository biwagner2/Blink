...
import 'package:blink_v1/frontend/pages/onboarding/question_screens/questionScreen10.dart';
import 'package:flutter/material.dart';
//import 'package:supabase_flutter/supabase_flutter.dart';


class QuestionScreen9 extends StatelessWidget
{
  const QuestionScreen9({Key? key}) : super(key: key);
  @override
          ...
          children: [
           ...
           const SizedBox(height: 100), // Adjust as needed
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const QuestionScreen10()),
                );
            },
            style: ButtonStyle(
